...
\restrict cQpwP9zac7Vf7RL6r0L1Lbq3TlblNXNRWMOjPT81mVYc09QnkCjFe87IsmViV7k
...
DROP INDEX IF EXISTS public.idx_items_search_text;
DROP INDEX IF EXISTS public.idx_items_search;
DROP INDEX IF EXISTS public.idx_items_medusa_product;
...
DROP INDEX IF EXISTS public.idx_item_images_embedding;
DROP INDEX IF EXISTS public.idx_item_images_ai_unprocessed;
...
CREATE TABLE public.action_logs (
    ...
    CONSTRAINT action_logs_action_type_check CHECK (((action_type)::text = ANY (ARRAY[('checkout'::character varying)::text, ('checkin'::character varying)::text, ('transfer'::character varying)::text, ('update'::character varying)::text, ('audit'::character varying)::text, ('maintenance'::character varying)::text, ('archive'::character varying)::text, ('restore'::character varying)::text, ('create'::character varying)::text, ('delete'::character varying)::text])))
);
...
CREATE TABLE public.items (
    ...
    storage_detail text,
    search_text text,
    medusa_product_id character varying(255),
    estimated_value numeric(12,2),
    msrp_price numeric(12,2),
    msrp_source text,
    msrp_lookup_query text,
    msrp_last_checked timestamp with time zone,
    list_price numeric(12,2),
    sold_price numeric(12,2),
    sold_date date,
    listing_url text,
    CONSTRAINT items_rating_check CHECK (((rating >= (0)::numeric) AND (rating <= (5)::numeric))),
    CONSTRAINT items_status_check CHECK (((status)::text = ANY (ARRAY[('available'::character varying)::text, ('checked_out'::character varying)::text, ('maintenance'::character varying)::text, ('storage'::character varying)::text, ('archived'::character varying)::text, ('lost'::character varying)::text, ('disposed'::character varying)::text])))
);
...
CREATE TABLE public.item_images (
    ...
    ai_description text,
    ai_main_color character varying(100),
    ai_object_type character varying(255),
...
COPY public.item_images (id, item_id, image_url, alt_text, display_order, is_primary, created_at, ai_processed, ai_description, ai_main_color, ai_object_type, ai_detected_text, ai_tags, ai_processed_at, embedding, ai_corrected) FROM stdin;
1	11	https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=600&h=400&fit=crop	Cisco UCS C220 M5	0	t	2026-02-08 16:23:21.379383+00	t	A rack-mounted 1U server with a metallic silver chassis. The front panel features dual power supply indicators, multiple drive bays with blue release levers, and Cisco branding on the right side.	silver	server	CISCO UCS C220 M5  S/N: FCH2149V0A3  PID: UCSC-C220-M5SX	["silver", "server", "rack-mount", "1U", "Cisco"]	2026-02-08 16:23:21.379383+00	[0.02671706,0.019468142,-0.049928695,0.013058939,0.007686705,-0.027144665,0.009297494,0.044001095,0.010122883,-0.01991104,0.01639075,-0.01163084,-0.015202357,0.014162131,0.00049691414,-0.0034510684,-0.0012598587,-0.016190542,0.025150187,0.028372535,0.11741365,0.01216569,0.023113603,0.008478553,0.017217949,0.024277035,0.019425888,-0.002849735,0.01969359,0.016799444,-0.0044110045,0.011186153,-0.02983396,0.06639686,-0.03717038,-0.023279043,0.0077415695,0.013277935,0.010663074,-0.061858512,-0.04938953,-0.043615993,-0.016809914,-0.05162774,0.0035441462,-0.045187697,-0.004128656,-0.0025252714,0.010053116,0.028863737,0.0146900965,-0.0038676132,-0.01485706,-0.00975546,0.027900444,0.029703967,-0.026039366,0.0006283066,-0.010818706,0.00499267,-0.06832106,-0.018616613,-0.015156173,0.012002523,0.06213967,0.014284039,-0.029688405,-0.070557736,-0.011322605,0.04327299,-0.014713008,-0.007313336,-0.024263753,-0.010260646,0.0034182528,-0.03903343,0.007523108,
053218905,-0.0115014305,0.05345986,0.022705337,0.0052592917,-0.0014201392,-0.024853868,-0.01875526,-0.011393344,-0.0034998092,0.008719472,-0.0015545533,0.012595102,0.013839451,0.016997712,-0.036050763,0.014097463,-0.060618505,-0.020882001,0.030232523,0.0029282721,-0.0004662226,0.018779574,-0.037240986,0.005938714,-0.0052873497,-0.040103003,-0.013527457,0.027525198,0.023145072,-0.025452431,-0.053725585,-0.004897612,0.094645955,0.00514663,0.014832031,-0.056004185,-0.007202141,0.01481192,0.03552856,-0.004373374,-0.02260048,-0.0857553,0.006368913,0.03615869,-0.016675102,0.028973099,0.030568235,-0.02035098,-0.016250534,0.042763285,-0.008772833,-0.00042945603,0.02464094,-0.0041945507,-0.005263313,-0.030353718,-0.041356932,-0.049888134,-0.027060362,-0.032973837,0.003015586,-0.021205576,-0.0049907644,-0.012814219,0.016865227,0.00853717,0.07655627,0.048255213,0.033066023,0.005937097,0.02290086,-0.01643647,0.04560472,-0.015381407,0.0078561995,-0.0075948946,-0.050891217,0.072696485,-0.033695016,0.015522271,-0.06585164,-0.036509927,0.020237649,-0.018478515,0.0039016444,-0.019437982,0.0032536115,0.0036243272,-0.020289121,-0.009844912,0.009244255,0.028397286,-0.012418238,-0.023572022,0.0040775565,-0.0069004167,-0.010019385,0.031552125,-0.034452736,-0.020645428,-0.0010546749,0.02660479,0.0042713815,-0.089993276,-0.027256526,-0.013499016,0.021726072,0.004195833,-0.008876632,0.01365898,0.005012998,-0.02888093,0.011618922,-0.031072492,0.021363426,0.033220552,-0.045495115,-0.057553254,-0.01892366,-0.00061808707,-0.03130519,0.0082177045,-0.022774072,0.051662367,-0.0032968707,-0.005855066,-0.019755602,-0.003265338,0.005028565,0.027785216,0.011960758,-0.021134483,0.017608153,0.015848381,-0.015617201,-0.01351294,0.005006404,-0.08148495,-0.08331071,0.00780328,-0.019774644,0.03482263,-0.0056314133,-0.04382081,0.020059979,-0.010948525,-0.0066918847,-0.0029561901,-0.040144607,0.032496456,-0.024147324,0.0069386023,0.029779129,0.003332577,0.014080227,-0.026804406,-0.034598853,0.018805424,0.012715428,0.023318134,0.023251707,-0.033576015,0.03573457,-0.022797046,-0.012706928,0.037087448,0.02453635,0.038290743,-0.053140312,-0.023454035,-0.025273308,-0.011043331,-0.0015477171,0.01904441,-0.010949919,0.0006069435,0.007674175,0.011680693,0.025499254,0.10261414,-0.005871739,-0.008126664,-0.0409998,-0.0042687478,0.020878557,-0.03917384,-0.05845522]	f
\.
...
SELECT pg_catalog.setval('public.item_images_id_seq', 1, true);
...
--
-- Name: idx_item_images_ai_unprocessed; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_item_images_ai_unprocessed ON public.item_images USING btree (ai_processed) WHERE (ai_processed = false);


--
-- Name: idx_item_images_embedding; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_item_images_embedding ON public.item_images USING ivfflat (embedding public.vector_cosine_ops) WITH (lists='10');
...
--
-- Name: idx_items_medusa_product; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_items_medusa_product ON public.items USING btree (medusa_product_id) WHERE (medusa_product_id IS NOT NULL);
...
--
-- Name: idx_items_search_text; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_items_search_text ON public.items USING gin (to_tsvector('english'::regconfig, COALESCE(search_text, ''::text)));
...
\unrestrict cQpwP9zac7Vf7RL6r0L1Lbq3TlblNXNRWMOjPT81mVYc09QnkCjFe87IsmViV7k
